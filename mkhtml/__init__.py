...
def parse_swatches(swatches, extra_width=6, extra_height=4, swatches_per_row=20):
    ...
    for line in swatches:
        # The space is registered as the separator of the output
        # of the project 4.
        if line.strip() == "":
        ...
        html_text = html_text + swatch_template.format(
            color=data[0],
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Turn output file of CS2401's Project 4 into the HTML file."
    )
    parser.add_argument(
        "filename", type=str, help="the name of the file to be processed"
    )
    parser.add_argument(
        "-c",
        "--columns",
